...
public class NavTrialActivity extends AppCompatActivity
    ...
    //From right side settings button. Remove if not needed
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(R.menu.nav_trial, menu);
        return true;
    }
    //From right side settings button. Remove if not needed
    @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        //For adding Fragment to center content of navigation activity.
        if (fragment != null) {
